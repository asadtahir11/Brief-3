...
--
-- Current Database: `sqlix_bdd`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sqlix_bdd` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
INSERT INTO `absorber` VALUES (1,'2052-02-18',7,3),(1,'2052-02-20',2,2),(1,'2052-02-20',8,2),(1,'2052-04-03',7,1),(1,'2052-04-03',15,2),(1,'2052-06-06',13,2),(1,'2052-08-18',8,3),(1,'2052-08-18',16,1),(1,'2052-11-26',10,2),(2,'2052-02-18',1,4),(2,'2052-04-03',1,5),(2,'2052-06-06',7,1),(2,'2052-07-18',7,3),(2,'2052-10-23',7,4),(2,'2052-11-26',8,2),(3,'2052-02-20',7,1),(3,'2052-04-03',1,4),(3,'2052-06-06',8,4),(3,'2052-08-18',10,2),(3,'2052-09-20',7,5),(3,'2052-10-23',13,1),(4,'2052-05-05',1,2),(4,'2052-08-18',7,2),(4,'2052-09-20',1,2),(4,'2052-10-23',13,3),(5,'2052-05-10',1,4),(5,'2052-05-10',2,1),(5,'2052-06-07',1,2),(5,'2052-07-17',7,1),(5,'2052-11-26',13,2),(5,'2052-11-26',16,2);
...
CREATE TABLE `categorie` (
  `CodeCat` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `NomTrophee` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `fabriquer` (
  ...
  KEY `FK_num_hab` (`NumHab`),
  CONSTRAINT `FK_num_hab` FOREIGN KEY (`NumHab`) REFERENCES `habitant` (`NumHab`),
  CONSTRAINT `FK_num_potion` FOREIGN KEY (`NumPotion`) REFERENCES `potion` (`NumPotion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fabriquer` VALUES (2,2),(2,5),(3,3),(4,1),(4,4),(4,5),(6,4);
...
CREATE TABLE `habitant` (
  ...
  PRIMARY KEY (`NumHab`),
  KEY `FK_NumQualite` (`NumQualite`),
  KEY `FK_NumVillage` (`NumVillage`),
...
CREATE TABLE `potion` (
  `NumPotion` int(11) NOT NULL DEFAULT '0',
  `LibPotion` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Formule` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ConstituantPrincipal` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `province` (
  ...
  `NomProvince` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NomGouverneur` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `qualite` (
  ...
  `LibQualite` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `resserre` (
  ...
  `NomResserre` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `trophee` (
  ...
  `CodeCat` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NumPreneur` int(11) NOT NULL DEFAULT '0',
  `NumResserre` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `trophee` VALUES (1,'2052-04-03','BLE',7,3),(2,'2052-04-03','BLT',11,3),(3,'2052-05-05','CDN',15,1),(4,'2052-05-05','CLE',16,2),(5,'2052-06-06','CCN',16,2),(6,'2052-06-06','BLT',8,1),(7,'2052-08-18','CCN',8,1),(8,'2052-09-20','CLT',1,3),(9,'2052-10-23','CDN',7,2),(10,'2052-10-23','CLE',16,1);
...
CREATE TABLE `village` (
  `NumVillage` int(11) NOT NULL DEFAULT '0',
  `NomVillage` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NbHuttes` int(11) NOT NULL DEFAULT '0',
  `NumProvince` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`NumVillage`),
  KEY `FK_NumProvince` (`NumProvince`),
...
-- Dump completed on 2021-02-24  0:58:33
